            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="#" id="google-lens-btn" class="google-lens-btn">
        ...
        <?php if ($meat_info): ?>
            <div class="result-card">
                ...
                <div class="info-row">
                    ...
                    <span class="status-badge <?php echo $meat_info['status_pengambilan'] == 'sudah' ? 'status-sudah' : 'status-belum'; ?>">
                ...
                <?php if ($meat_info['status_pengambilan'] == 'belum'): ?>
                    <div class="mt-4 pt-3 border-top">
                        ...
                        <form method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mengkonfirmasi pengambilan daging ini?')">
                ...
                <?php else: ?>
                    <div class="mt-4 pt-3 border-top">
                        <div class="alert alert-info mb-0">
                            <i class="fas fa-info-circle me-2"></i>
                            Daging sudah diambil pada <?php echo date('d/m/Y H:i', strtotime($meat_info['tanggal_pengambilan'])); ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
